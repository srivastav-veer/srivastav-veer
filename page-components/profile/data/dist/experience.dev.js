...
var experiences = [{
  ...
  pointers: ['Saved more than $40K on cloud bills by optimizing cloud infra.', 'Set up the first core engineering team (13 Engineers) in less than 2 months.', 'Created the end-to-end sprint process.']
}, {
  organization: {
    name: 'Toppr',
  ...
  pointers: ['Delivered the quiz platform in less than 21 days.', 'Successfully delivered and managed the end-to-end implementation of online classes via Zoom API.']
}, {
  organization: {
    name: 'Xwards',
    url: '#'
  ...
  pointers: ['Managing no-buffering on content for a seamless experience.', 'Syncing logs and user activities while the tablet was in no network zone.', 'Real-time intelligence for pushing Ads based on logs from devices.', 'Developing systems to stop device theft.']
}, {
  organization: {
...
//# sourceMappingURL=experience.dev.js.map
